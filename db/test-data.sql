...
(1, 'xiaoming', '13900139001', 'xiaoming@campus.edu', '$2b$10$wQY0FlPWcdAysC.bv6ND1uqe7eDoTRbGCl/E0.zVaA1xy.PvyeJTq', NULL, 4.8, 1, '张三', '2021001', '计算机学院', '计科2101', '热爱编程，乐于助人', 100.00, 0, NOW()),
(2, 'xiaohong', '13900139002', 'xiaohong@campus.edu', '$2b$10$fGOFok50lnPFBCgXtyqaIO72sfnk..4P7gLUh0unEYELhS2S.qs2u', NULL, 5.0, 1, '李四', '2021002', '电子工程学院', '电信2102', '专注学习，擅长代取快递', 50.50, 0, NOW()),
(3, 'xiaowang', '13900139003', 'xiaowang@campus.edu', '$2b$10$56l5q2blDgDZBxV3dW68ZeKJZrv.Jd09qV/n40rsAedzm7mRC1o0q', NULL, 3.5, 0, NULL, NULL, NULL, NULL, '新人用户', 0.00, 0, NOW()),
(4, 'admin', '13900139000', 'admin@campus.edu', '$2b$10$htNZPp3uGm5LXf9It.rvC.XXltBKXJSNdIQF7PWYDR6F0TPrkbc5.', NULL, 5.0, 1, '管理员', 'A001', NULL, NULL, '系统管理员', 9999.99, 1, NOW());
...
(1, '帮忙取东区食堂午饭', 0, '代取快递', '一份宫保鸡丁盖饭，送到西区宿舍5号楼302，谢谢！', 1, 'xiaoming', 4.8, '10元', 10.00, DATE_ADD(NOW(), INTERVAL 2 HOUR), 'closed', '微信13900139001', NULL, 'payer', NULL, NOW(), NOW()),
